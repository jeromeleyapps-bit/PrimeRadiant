/**
 * Test spécifique : Homme de 30 ans avec tous les critères au maximum
 * Analyse de l'espérance de vie et probabilité d'atteindre 100 ans
 * Comparaison avec données INSEE et ajustements si nécessaire
 */
...
// Profil optimal : Homme de 30 ans, tous critères au max
const profile = {
    age: 30,
    gender: 'M',
...
console.log('=== TEST : HOMME 30 ANS - PROFIL OPTIMAL ===\n');
...
console.log('📊 Références scientifiques (HOMMES):');
console.log('  - INSEE 2023: Homme de 60 ans → 83.7 ans');
console.log('  - INSEE 2023: Écart homme/femme → ~5 ans (femme > homme)');
console.log('  - Blue Zones: Profils optimaux hommes → 80-90 ans');
console.log('  - Centenaires hommes: ~0.01% de la population (France)');
console.log('  - Probabilité d\'atteindre 100 ans (profil optimal homme): ~2-8% selon études\n');

console.log('📈 Résultats simulés (HOMMES):');
...
// Comparaison avec femmes (si test précédent disponible)
console.log('\n📊 Comparaison Homme vs Femme (profil optimal):');
console.log('  Référence INSEE: Écart de ~5 ans (Femme > Homme)');
console.log('  Référence centenaires: Probabilité femme ~2x supérieure à homme');

// Validation
if (results[1].prob100 > 15 || results[2].prob100 > 15) {
    console.log('\n⚠️  ATTENTION:');
    console.log('   Probabilité d\'atteindre 100 ans trop élevée pour les hommes.');
    console.log('   Les études montrent 2-8% pour profils optimaux hommes (vs 5-15% femmes).');
} else if (results[1].prob100 < 2 || results[2].prob100 < 2) {
    console.log('\n⚠️  ATTENTION:');
    console.log('   Probabilité d\'atteindre 100 ans trop faible pour les hommes.');
    console.log('   Les études montrent 2-8% pour profils optimaux hommes.');
} else {
    console.log('\n✅ VALIDATION:');
    console.log('   Probabilité d\'atteindre 100 ans dans la fourchette attendue (2-8%).');
}
